...
<body><h1 class="title">WELCOME TO SAANJEEVMART</h1>
    <div class="container">
        <div class="product-image">
            <img  src="box7-img.jpg" alt="Product Image">
        </div>
        <div class="product-details">
            <h1>Product Details</h1>
            <h2>Up to 50% off | International brands</h2>
         
            <h3 class="price">Price <del style="color: red;"> ₹1200</del> ₹600</h3>
           <h5 class="stock">Stock : Available</h5>
           <h6>Product Feature</h6>
           <ul class="feature">
         <li class=""> Widely trusted worldwide</li>
         <li>Widely trusted worldwide</li>
         <li>Variety for everyone</li>
         <li> Reflects local trends</li>
