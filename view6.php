...
<body><h1 class="title">WELCOME TO SAANJEEVMART</h1>
    <div class="container">
        <div class="product-image">
            <img  src="box6-img.jpg" alt="Product Image">
        </div>
        <div class="product-details">
            <h1>Product Details</h1>
            <h2>Minimum 50% off | Men's clothing</h2>
         
            <h3 class="price">Price <del style="color: red;"> ₹1000</del> ₹500</h3>
           <h5 class="stock">Stock : Available</h5>
           <h6>Product Feature</h6>
           <ul class="feature">
         <li class="">  Easy and relaxed</li>
         <li>Keeps cool naturally</li>
         <li>Suitable for occasions</li>
         <li>Long-lasting wear guaranteed</li>
