...
<body><h1 class="title">WELCOME TO SAANJEEVMART</h1>
    <div class="container">
        <div class="product-image">
            <img  src="box4-img.jpg" alt="Product Image">
        </div>
        <div class="product-details">
            <h1>Product Details</h1>
            <h2>Helth, beauty & personal care</h2>
         
            <h3 class="price">Price <del style="color: red;"> ₹150</del> ₹100</h3>
           <h5 class="stock">Stock : Available</h5>
           <h6>Product Feature</h6>
           <ul class="feature">
         <li class="">  Hydrates and nourishes</li>
         <li> Hides imperfections effectively</li>
         <li> Supports gut health</li>
         <li> Adds color and hydration</li>
        
         <li>Fast & free Delevery</li>
         <li>  100% Orginal</li>
         <li> Smooths and brightens skin</li>
         <li >..more</li>
        </ul>
