...
<body><h1 class="title">WELCOME TO SAANJEEVMART</h1>
    <div class="container">
        <div class="product-image">
            <img  src="box3-img.jpg" alt="Product Image">
        </div>
        <div class="product-details">
            <h1>Product Details</h1>
            <h2>Up to 60% off | Car, bike parts & accessories</h2>
         
            <h3 class="price">Price <del style="color: red;"> ₹30000</del> ₹22000</h3>
           <h5 class="stock">Stock : Available</h5>
           <h6>Product Feature</h6>
           <ul class="feature">
         <li class=""> Power and performance</li>
         <li>Miles per gallon</li>
         <li>Seat Height: Rider accessibility important</li>
         <li>Technology: Advanced riding features</li>
        
         <li>Fast & free Delevery</li>
         <li>  100% Orginal</li>
         <li>Storage Capacity: Carry essentials easily</li>
         <li>..more</li>
        </ul>
